...
select nome, salario from funcionarios
where salario > 8000 and pais = 'EUA'

--exercicio 4

select nome, salario, salario * 1.1 as salario_aumento from Funcionarios
...
select nome, salario, pais from Funcionarios
where salario between 10000 and 12000 and pais = 'Reino Unido'
...
--exercicio 8
select nome, cidade, contato from Clientes
where pais = 'Brasil'
...
--5
SELECT NumPed, DataPed, DataEntrega,DATEDIFF(DAY, DataPed, DataEntrega) AS diferenca FROM Pedidos

--6
SELECT NumPed, DataPed, DataEntrega, DATEADD(DAY, 10, DataEntrega) AS entrega FROM Pedidos

--7
SELECT nome, DATENAME(MONTH, DataNasc) AS mes FROM Funcionarios

--8
SELECT DATEDIFF(DAY, '2010-03-03', GETDATE()) AS dias_passados